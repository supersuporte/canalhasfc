...
- (void)viewDidLoad
{
    ...
    UIImage *titulo = [UIImage imageNamed:@"titleFinancas"];
...
- (void)montaResultadoResumo
{
	...
	// Total
    UILabel *lineTotal = [[UILabel alloc] initWithFrame:CGRectMake(6, 45, 205, 1)];
