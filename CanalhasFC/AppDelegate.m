...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [noticiasTabBarItem setImage:[UIImage imageNamed:@"tabBarNoticias"]];
    ...
    [financasTabBarItem setImage:[UIImage imageNamed:@"tabBarFinancas"]];
    ...
    [storeTabBarItem setImage:[UIImage imageNamed:@"tabBarStore"]];
